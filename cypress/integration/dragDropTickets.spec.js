...
describe('Drag & Drop Tickets accross the columns', () => {
    ...
    it('To Do -> In Progress & Done    In Progress -> Done & To Do   Done -> To Do & In Progress', () => {
        ...
        cy.dragDrop(selectors.column2.title, selectors.column1.title+inputText+'3')
        cy.dragDrop(selectors.column2.title, selectors.column1.title+inputText+'1')
        cy.dragDrop(selectors.column3.title, selectors.column1.title+inputText+'2')
        ...
        cy.ticketsExistInColumn(selectors.column2.title, 
            [
                ...
                selectors.column1.title+inputText+'3', 
                selectors.column2.title+inputText+'1'
            ], 3, selectors.column2.color)
        cy.ticketsExistInColumn(selectors.column3.title, 
            [
                selectors.column1.title+inputText+'2', 
                selectors.column3.title+inputText+'2', 
                selectors.column3.title+inputText+'1'
            ], 3, selectors.column3.color)
        
        //Drag tickets from In Progress to Done and To Do
        cy.dragDrop(selectors.column3.title, selectors.column1.title+inputText+'3')
        cy.dragDrop(selectors.column3.title, selectors.column2.title+inputText+'1')
        cy.dragDrop(selectors.column1.title, selectors.column1.title+inputText+'1')
        // Assertion of all column/tickets
        cy.ticketsExistInColumn(selectors.column1.title, 
            [
                selectors.column1.title+inputText+'1'
        ...
        cy.ticketsExistInColumn(selectors.column3.title, 
            [
                ...
                selectors.column3.title+inputText+'2', 
                selectors.column3.title+inputText+'1'
            ], 5, selectors.column3.color)

        //Drag tickets from Done to To Do and In Progress
        cy.dragDrop(selectors.column1.title, selectors.column1.title+inputText+'2')
        cy.dragDrop(selectors.column2.title, selectors.column1.title+inputText+'3')
        cy.dragDrop(selectors.column1.title, selectors.column2.title+inputText+'1')
        cy.dragDrop(selectors.column2.title, selectors.column3.title+inputText+'1')
        //Assertion of all column/tickets
        cy.ticketsExistInColumn(selectors.column1.title, 
            [
                selectors.column2.title+inputText+'1',
